...
link2_status=$(curl -Is https://dl.bobpony.com/windows/11/en-us_windows_11_22h2_x64.iso | grep HTTP | cut -f2 -d" ")
...
if [ $link1_status = "200" ] ; then 
	...
	sudo wget -P /mediabots https://dl.bobpony.com/windows/11/en-us_windows_11_22h2_x64.iso
else
