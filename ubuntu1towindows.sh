...
link1_status=$(curl -Is https://dl.bobpony.com/windows/10/en-us_windows_10_22h2_x64.iso | grep HTTP | cut -f2 -d" " | head -1)
link2_status=$(curl -Is https://dl.bobpony.com/windows/server/2022/en-us_windows_server_2022_updated_nov_2024_x64_dvd_4e34897c.iso | grep HTTP | cut -f2 -d" ")
#sudo wget -P /mediabots https://archive.org/download/WS2012R2/WS2012R2.ISO # Windows Server 2012 R2 
if [ $link1_status = "200" ] ; then 
	sudo wget -O /mediabots/WS2012R2.ISO https://dl.bobpony.com/windows/10/en-us_windows_10_22h2_x64.iso
elif [ $link2_status = "200" -o $link2_status = "301" -o $link2_status = "302" ] ; then 
	sudo wget -P /mediabots https://dl.bobpony.com/windows/server/2022/en-us_windows_server_2022_updated_nov_2024_x64_dvd_4e34897c.iso
else
